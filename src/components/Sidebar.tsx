...
import { PLATE_CONFIGS, PIPETTE_PRESETS, LIQUID_COLORS } from '../types';
...
export default function Sidebar({
  ...
  // Find the selected well's current state for display
  ...
  return (
    <aside className="w-56 shrink-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto flex flex-col py-3 text-sm text-gray-700 dark:text-gray-300">
      ...
      <Section title="Add Plate">
        {(Object.keys(PLATE_CONFIGS) as PlateType[]).map(type => (
          <button
            key={type}
        ...
        <Section title="Well Editor">
          <div className="px-3 space-y-2">
            ...
            <div className="flex gap-1">
              <button
                onClick={() => onSetWellLiquid(selectedWell, wellVolume, wellLiquid)}
